...
To create a feature branch, type `git checkout -b <branch_name>`, substituting `<branch_name>` with the name of your branch. It's a good idea to include in the branch name your name and a one or two word description of what you are doing.
